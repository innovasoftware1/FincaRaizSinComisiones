                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="fila">
                        <div class="box">
                            ...
                            <select name="permuta" id="" class="input-entrada-texto">
                                <option value="0" <?php if ($propiedad['permuta'] == "No") {
                                                        echo "selected";
                                                    } ?>>No</option>
                                <option value="1" <?php if ($propiedad['permuta'] == "Si") {
                                                        echo "selected";
                                                    } ?>>Sí</option>
                            </select>
                        </div>
                    ...
                    <div class="box">
                        ...
                        <select name="financiacion" id="financiacion" class="input-entrada-texto" required>
                            <option value="1" <?php if ($propiedad['financiacion'] == "1") {
                                                    echo "selected";
                                                } ?>>Sí</option>
                            <option value="0" <?php if ($propiedad['financiacion'] == "0") {
                                                    echo "selected";
                                                } ?>>No</option>
                        </select>
                    </div>
                    ...
                    <div class="fila">
                        ...
                        <div class="box">
                            ...
                            <select name="salidas_bogota" id="salidas_bogota" class="input-entrada-texto" required>
                                <option value="autopista_sur" <?php if ($propiedad['salidas_bogota'] == "autopista_sur") {
                                                                    echo "selected";
                                                                } ?>>Autopista Sur</option>
                                <option value="autopista_calle_80" <?php if ($propiedad['salidas_bogota'] == "autopista_calle_80") {
                                                                        echo "selected";
                                                                    } ?>>Autopista Calle 80</option>
                                <option value="autopista_calle_13" <?php if ($propiedad['salidas_bogota'] == "autopista_calle_13") {
                                                                        echo "selected";
                                                                    } ?>>Autopista Calle 13</option>
                                <option value="autopista_via_la_calera" <?php if ($propiedad['salidas_bogota'] == "autopista_via_la_calera") {
                                                                            echo "selected";
                                                                        } ?>>Autopista Via La Calera</option>
                            </select>
                        </div>
